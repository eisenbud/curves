...
\fix{This section isn't yet a Preface, but here is a possible first sentence of a future preface:}
The basic objects of study in this book are smooth, connected projective algebraic curves over the complex numbers. It is easy to see that every such curve is a compact Riemann surface, and, though it is more difficult to prove, \cite{****} every compact Riemann surface can be represented as a projective curve.
