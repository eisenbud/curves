...
It's worth remarking that one consequence of the modern theory is to extend the construction of the Picard scheme to singular curves as well as smooth ones. This won't come up often in the present text, where we view singular curves as images of their normalizations and analyze them in those terms; but even here the notion of the Picard scheme of a singular curve does arise: in Chapter~ref{Brill Noether proof chapter}, we'll have occasion to describe the Picard schemes of $g$-nodal and $g$-cuspidal curves.
...
\fix{would it make sense to mention the functorial characterization of quotients? That is, a map $f : X/G \to Z$ is a map $\tilde f : X \to Z$ such that $f\circ g = f$ for all $g$?}
...
It should be said that this is not the final word on low-degree embeddings of curves: Theorem~\ref{grd omnibus}) shows that a general curve of genus $g$ can in fact be embedded in $\PP^{3}$ as curves of degree $d = \lceil 3g/4 \rceil + 3$.
