...
$\ff_{C/C_{0}} $ is the annihilator of the quotient of two locally cyclic modules
\vspace*{3pt}
$$
\vspace*{3pt}
...
\blue{\emph{infinitely near triple point}:}
