...
%\subsection{Examples}
%
%We have already sen that a fine moduli space exists for the first two moduli problems mentioned above: for the moduli problem of  effective divisors oif degree $d$ on a given curve, we have the symmetric product $C_d$, and for line bundles of degree $d$ on a given curve we have the Piacrd variety. Here are some other examples:
%
