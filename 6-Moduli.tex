...
What does such a space look like? The answer is easiest to see if we work over $\CC$ and use the classical or \'etale topology; in this setting, we consider the incidence correspondence \fix{you've gone from $B\subset \PP^1$ to $B \in \PP^b$. This should be prepared (moduli of divisors section before this?}
