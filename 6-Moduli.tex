...
\subsection{Parametrizing twisted cubics} The set of twisted cubics---that is, smooth curves of degree 3 in $\PP^3$---is an open subset of the Hilbert scheme $Hilb_{3m+1}(\PP^3)$.\fix{Let's give a simple reason for "open". Separate this as a lemma about projective
...
\fix{say first diff is may not be fg; but... give reference...}
...
of the cusp.
\fix{picture}
This example is worked through in detail in \cite[****]{Harris-Morrison}.
\end{example}
