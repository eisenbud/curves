...
families of objects; ideally, the notion of ``natural'' we will adopt means that every family of objects of a given sort
...
fine moduli spaces do not exist for all moduli problems. As we'll see in Section~\ref{}, \fix{****}there does not exist a solution to the moduli problem of abstract curves of genus $g$.
