...
\item Describe the map $\phi_{|D|} : C \to \PP^2$. \fix{what sort of answer does this want?}
...
\fix{ why aren't $x^2dx/y^2, x^3dx/y^2$ holomorphic, since $x^2/y^2, x^3/y^2$ should be finite at $p$}
