...
\fix{on the closure of the curve y^3z^2-x^5+z^5$ in $\PP^2$ the point at infinity is $x=z=0, y=1$. In local analytic coordinates this is
$z^2+z^5-x^5 = z'^2-x^5$, a cusp with parameterization $z'=t^5, x= t^2$. Why doesn't this show that $x$ has simple ramification
(index 1) at infinity? Unfortunately this would make the ramification divisor $R = 2\sum r_i+1$, which is odd and impossible.}

\item Show that the genus of $C$ is 4.
\item Establish the linear equivalences
$$
3p \sim 3r_\alpha \quad \text{and} \quad r_1+ \dots + r_5 \sim 5p. Hint; $x/(x-\zeta^i)$ and $(y+1)/y$.
$$
