...
$dx$: double zeros at $r_\alpha$, hence a 4th order pole at $p$. so $dx/y^2$ is holomorphic, with 6-th order 0 at p. So $(1,x,x^2)dx/y^2, dx/y$ are holomorphic
...
\item If $E = 3p$, show that $r(E) = 1$; that $|E|$ is the unique $g^1_3$ on $C$ and that $2E \sim K$. \fix{uniqueness uses geom RR and the quadric cone.}
\end{enumerate}
\end{exercise}
