...
In Chapters~\ref{HilbertSchemesI} and \ref{HibertSchemes2} we see several more instances of the application of liaison to the study of curves in $\PP^3$. The method is largely limited to curves in $\PP^3$ (and subvarieties $X \subset \PP^r$ of codimension 2 in general); for example, you can't use it to do Exercise~\ref{rational normal hilbert} for $r \geq 4$.
