...
the two equations above are satisfied. This relation turns out to be symmetric, and the degrees and (arithmetic) genera are related as in the simple case above:

\begin{theorem}\label{liaison-full version}
