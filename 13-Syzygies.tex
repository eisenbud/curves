...
for $i = 1,\dots,t$. 
%\begin{proposition}
%If $R$ is a regular local ring, then
%$$
%\depth M = \max\{s \mid \Ext^{\dim R -s}(M,R) \neq
%$$
%\end{proposition}
...
Finally, we will use an elementary part of duality theory: if $S$ is a regular local ring and $R = S/(f_1,\dots, f_c)$, 
...
$D$ is again a purely 1-dimensional scheme. 
