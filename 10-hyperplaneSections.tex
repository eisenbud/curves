...
\item If $C$ is hyperelliptic,  $C_0$ has only one singular point, which is an ordinary $g$-fold point (Figure~\ref{Fig9.4}).\end{enumerate}
\end{theorem}
