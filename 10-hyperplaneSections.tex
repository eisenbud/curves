...
\label{9.2}
\end{figure}
\footnote{After \citeN{Kronecker} proved that every algebraic set in
  $\PP^{n}$ is set-theoretically the intersection of $n+1$
  hypersurfaces, \citeN{Vahlen} claimed that Kronecker's result was
  sharp because the rational quintic space-curve described in
  Figure~\ref{9.2} could not be the intersection of 3 hypersurfaces.
  ...
  precisely in this curve. It is now known that every algebraic set in
