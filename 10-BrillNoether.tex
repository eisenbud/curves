...
%\fix{We're using the symbol $\mu$ for both the Abel-Jacobi map $C_d \to \pic_d(C)$ and the multiplication map above, which is confusing. Can we adopt a different symbol for the multiplication map?}
...
As in the case of the general curve of genus 6, the space of quadratic forms in the ideal of $C$ is 6-dimensional. However, by the geometric Riemann-Roch theorem, the triples of points in the divisors of the $g^1_3$ are coliinear,
...
In fact that the two subcases of trigonal curves of genus 6 are distinguished by the isomorphism classes of the scrolls containing their canonical models: in the first case the lines making up the scroll join corresponding points of a twisted
