...
$$
as a set, $B'$ is the set of isomorphisms of between corresponding fibers in the two families. By Corollary~\ref{finite automorphism genus 1}, $B'$ is a finite cover
...
many advantages but involves a substantial investment in mastering the technical issues; readers who wish to pursue this avenue may consult \cite{Deligne-Mumford}, \cite{Olsson}, or the forthcoming book ``Stacks and Moduli'' by Jarod Alper.
\end{enumerate}
