...
\index{linear series}%
\index{series!linear|seeunder{linear}}%
...
If the vector space $V = H^0(\cL)$, the linear series is said to be
...
\index{conic}%
\index{cubic curve|seealso{twisted cubic}}\index{twisted cubic}%
