...
\end{figure}
\fix{Silvio: please show the two divisors, perhaps by color or bracket : p,q,r is one group and p, q', r' the other. The dashed lines could be the corresponding colors too.}
...
\end{figure}
\fix{Silivo: perhaps add a line from p to the double point, meeting the space curve in two points?}
