...
Here ``nondegenerate" means the image of the morphism $\phi$ is not contained in any hyperplane, and base-point free means that the base locus of $\sV$ is empty; in other words, there is no point of $C$ where all the sections in $V$
