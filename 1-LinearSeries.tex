...
intersection theory on these surfaces very concretely. 


\begin{example}[Quadrics in $\PP^3$]
 
Quadric surfaces in $\PP^3$ are classified by their rank:
\begin{itemize}
\item A quadric of rank 2 is the union of two planes; it cannot contain an nondegenerate irreducible curve
\item A quadric of ran 3 is a cone over a plane conic; it contains smooth irreducible curves of
degree $2d$ that are intersection with hypersurfaces of degree $d$; and smooth 
irreducible curves of degree $2d+1$
a  contains smooth hyperplane sections of
...
$$
\sL := \sO_{\PP^1\times \PP^1}(a,b) = \pi_1^*\O1a \otimes \pi_2^*\O1b
$$
...
\item There are reduced
irreducible curves in class $(a,b)$ if and only if $(a,b) = (1,0)$ or $(a,b) (0,1)$ or
both $a$ and $b$ are strictly positive.
\end{itemize}
\end{example}

\begin{example}[Quadric cones in $\PP^3$]
\end{example}
%\begin{itemize}
