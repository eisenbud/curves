...
called a 
\emph{pencil}\footnote{The word pencil comes from the latin (pencilla) and Italian (pennello) for paintbrush, the idea presumably
being that the hairs of the brush are like the curves of a pencil of divisors on an algebraic surface.}
\index{pencil!def}%
...
\begin{figure}\label{projection from a general point}
...
\marginpar{The vertical dotted line is missing an arrowhead at the bottom}
\begin{diagram}
& & \PP W^* \\
...
\begin{figure}\label{not very ample}
