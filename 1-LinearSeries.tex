...
\index{cubic!twisted}\index{twisted cubic}%
...
\begin{exercise}\label{here there be basepoints}
 ...
 series of dimension $<r$ on $\PP^r$ has a nonempty base locus. \tohint{1-01}
\end{exercise}
...
$\sV = (\sO_{\PP^r}(1), H^0(\sO_{\PP^r}(1)))$, and use this to show that $\Aut \PP^r = \PGL(r+1)$. \tohint{1-04}
\end{exercise}
