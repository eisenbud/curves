...
\pict{abstract curve and map to plane, lines in plane, points on curve.}
...
\pict{projection of a curve from P3 to P2 from a point off the curve, and another from a point on the curve. twisted cubic -> node,
tw cubic to cusp, tw cubic to conic. Show how the image of the point in the cubic becomes a tangent vector to the conic.}
