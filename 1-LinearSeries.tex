...
Moreover, if $X$ is a normal scheme (so that its local rings at the generic points of codimension 1 subvarieties are discrete valuation rings) then the Cartier divisors are the same as locally principal Weil divisors. See~\cite[Section II.6]{Hartshorne 1977} for more information. 
