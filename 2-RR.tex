...
%\fix{We'll state and at least sketch the proof of RR for arb coh sheaves, including duality in the form explained now in the linkage chapter.
%include the def of degree as $\chi(\sF) -\chi(\sO)$}
...
\fix{introduce the conductor, express $\delta$ as its colength in the case of plane c}
