...
which follows at once from the additivity of $\chi$ on exact squences.. Less trivially, we will explain in Chapter~\ref{linkageChapter} that there is is a sheaf $\omega_{C_0}$ called the canonical or dualizing sheaf of ${C_0}$ that is the analogue of the sheaf of differentials oa smooth curve, and in these terms we can rewrite
the formula above with duality as:
\begin{theorem} If ${C_0}$ is a projective curve and $\sF$ is a coherrent sheaf of rank $r$ and  degree $d$ then
$$ 
