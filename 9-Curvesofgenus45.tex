...
hyperelliptic-trigonal dichotomy for curves of genus $\leq 4$%
...
entirely in one of the half-spaces determined by the tangent line
at the cusp. This was first recorded in a 1744 letter from Euler to
\blue{Gabriel Cramer,}
...
%A ramphoid cusp on a quartic curve with affine parametrization
%$(t^2{+}t^3,t^4)$. Note that the real points of this affine curve lie
%entirely in one of the half-spaces determined by the tangent line
%at the cusp. This was first recorded in a 1744 letter from Euler to
%\blue{Gabriel Cramer,}
...
$n\leq 2d+1$ points in the plane fail to impose \blue{independent conditions}
...
\blue{Fulton's}
\blue{\it{elementary B\'ezout theorem}:}
