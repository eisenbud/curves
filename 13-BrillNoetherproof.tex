...
Of course every invertible sheaf on the zero-dimensional scheme $2q$ is trivial, and a chage of trivialization
...
sheaf. Nevertheliss we can describe these limits quite precisely.
...
The endomorphism ring of $I_0$, is commutative, contains $R_0$,  and (since it stabilzes the finitely
...
\begin{proof}
To start, let $\cC \to \Delta$ be a family of curves as in the proof of Lemma~\ref{cusp smoothing lemma}. Possibly
