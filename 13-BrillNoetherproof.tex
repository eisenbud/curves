...
$$
for $t\in \Delta$.
(See Figure~\ref{7.1}.)\fix{missing figure or wrong label}}
...
\caption{Divisor on a family of curves degenerating to a cuspidal curve. \fix{Silvio: distinguish the divisor
(parabola) with color.}
\label{Fig13.1}
\end{figure}
