...
\def\cbstart{{\color{factcolor}\hrule width\hsize height 3pt
\hbox to \hsize{\Large\cleaders\hbox{$\photon$}\hfil}\vskip-2pt}}
\def\cbend{\hskip0pt\lower7pt\hbox{}\par
{\color{factcolor}
\hbox to \hsize{\Large\cleaders\hbox{$\photon$}\hfil}\vskip-2pt\hrule width\hsize height 3pt
\relax}}
\newenvironment{fact}
  {\par\goodbreak\begin{factoid}\cbstart\normalfont\fontsize{11}{13}\selectfont}
  {\cbend\end{factoid}}
\newtheorem{factoid}[theorem]{Cheerful Fact}
