...
isomorphic to the \emph{structure sheaf} of locally defined functions $\cO_{\PP(V)}$. The space $V$ reappears as the space of global sections of $\cO_{\PP(V)}$.
 ...
 $E$ at a point $p$ to the space of sections of $\cF$ defined near $p$ modulo the ones vanishing at $p$. We will use the terms interchangeably. \fix{really? could we settle on one?}
