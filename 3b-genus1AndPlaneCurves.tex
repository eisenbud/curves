...
\section{Curves of genus 1 and the group law of an elliptic curve}\label{group law}
...
Hint: show that any $d-2$ points impose independent conditions on forms of degree $d-3$, and use Bertini to reduce to this case.
\end{exercise}
