...
\begin{figure}  % automatic bottom placement on opening page??
\vskip-14pt
$
...
that the set of smooth curves corresponds to an open subset of 
the projective space $\PP^{\sbinom{d+2}{2}-1} $.
...
\vadjust{\allowbreak}% allow club line for the sake of diagrams on next page
...
\index{invertible sheaf!family of --s on a curve}%
...
% don't punctuate diagrams that come after a colon
$$
...
\index{Matsusaka @Matsusaka, Teruhisa}%
...
\index{Hilbert scheme}%
\index{counting maps between curves}%
