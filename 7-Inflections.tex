...
Our proof will follow a suggestion of Castelnuovo, by specializing a smooth curve of genus $g$ to a general rational curve with $g$ nodes. To say what we mean by this, let's introduce a basic construction. Suppose first that $C$ is a smooth curve, and $p, q \in C$ two distinct points of $C$. We can identify the two points on $C$ to form a nodal curve $C/p\sim q$ as follows:
