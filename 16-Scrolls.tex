...
\begin{corollary}(Castelnovo's $2r+3$ Lemma)\label{Castelnouovo2r+3}
...
\begin{remark}
 ...
 is arithmetically Cohen-Macaulay (Corollary~\ref{canonical is acm}), the points of a hyperplane 
 section lie on the same number of independent quadrics as does $C$, and so such points
 impose only $2r+1$ conditions on quadrics, but  do not lie on a rational normal curve. 
