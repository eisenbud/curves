...
For a classical proof of Corollary~\ref{Castelnuovo2r+3} see for example \cite[]{Griffiths-Harris1978}.
\end{remark}
...
Theorem~\ref{1-generic basics}, the ideal $I_{2}(M)$ is prime and of codimension $\sum a_{i}-1$, as is the ideal of the scroll. Thus it suffices to show that the minors of $M$ vanish on the scroll.
