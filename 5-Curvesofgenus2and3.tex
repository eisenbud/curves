...
$$
In this context there is nothing special about the number 3, beyond the fact that every odd permutation in $S_3$ is a transposition; and we could treat coverings of
...
Note that the variety $\Pic_5(C)$ has dimension 2, while the sheaves of the form $K^2(p)$ form a one-dimensional subfamily. Thus in general $Q$ will be smooth; the set of invertible sheaves $L$
