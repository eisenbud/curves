...
For a nonspecial embedding, the two estimates above agree
...
\begin{theorem}\label{nonspecial Hilbert}
 ...
 this is the unique component of the restricted Hilbert scheme $\cHilb^\circ_{g,r,d}$.
\end{theorem}
...
nonspecial invertible sheaves of degree $d$ on curves of genus $g$
 ...
 Thus the dimension of  $\cHilb^\circ_{g,r,d}$ near $[C]$ is
$$
3g-3+ g + (r+1)(d-g-r) + (r+1)^2-1 = (r+1)d - (r-3)(g-1)
$$
as required. If $d>2g-2$, then every curve in $\cHilb^\circ_{g,r,d}$ is nonspecial, completing the proof.
\end{proof}
