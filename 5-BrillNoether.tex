...
The monodromy group of the general hyperplane section of an irreducible curve $C \subset \PP^r_\CC$ is the full symmetric group; in particular the varieties $Y^k$ are irreducible.
\end{theorem}
