...
To prove that $M$ contains a transposition, we will use the characteristic 0 hypothesis. As we shall see in Chapter~\ref[Theorem ****]{InflectionsChapter}, a general hyperplane $H$ containing
