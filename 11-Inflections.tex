...
\fix{ to add: a reference to put instead of the **** in Ch 9 (uniform chapter): By ***** \fix{in the inflections chapter} there is a tangent line $L$ to $C$ at a smooth point that is not flex tangent, and is not tangent to $C$ at any other point.}
