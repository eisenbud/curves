...
The answer is known only up to degree 8: \cite{Zariski} proves that a plane curve of degree 8 can have 15 but not 16 cusps.
See \cite{Calabri} and \cite{Kulikov} for recent contributions. 

\fix{add picture of quartic with 3 cusps, if they can all be made real, else just the usual 1. I'll write to Sottile and see if he has one}
