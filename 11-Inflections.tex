...
In this chapter, we will introduce the \emph{inflection points} of a linear system. \fix{add the idea that we get distinguished
points of a linear series, generalizing the ramification divisor of a hyperelliptic curve.}
We love this topic for its echos of classical algebraic geometry and it will provide the tools to give a proof of the Brill-Noether theorem in the following chapter.
...
To take the simplest: how many cusps can there be on a plane curve of geometric genus $g$ and degree $d$? \fix{refs? Zariski 1931, A. Calabri, Kulikov, Viktor S. (RS-AOS); Shustin, Eugenii (IL-TLAV)
Duality of planar and spacial curves: new insight.}

One thing we do know is the behavior of the inflection points for a general linear series; we will state this here and prove it as a corollary to the proof of the Brill-Noether theorem later in this chapter.
...
\fix{replace this with a ref to how it's used in BN existence. Consider adding the proof!}
...
\input{footer}\begin{exercise}\fix{add}
 Buchweitz' example
 \end{exercise}
