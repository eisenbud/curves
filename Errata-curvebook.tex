...
p. 90: In the skew-symmetric matrix B, the top 2 rows should be
$$
\begin{pmatrix}
 0&0&x_{0}&x_{2}&x_{3}\\
  0&0&x_{1}&x_{3}&x_{4}
\end{pmatrix}
$$
and the first two columns should, similarly, be the negative transpose of this matrix.

Also, delete the reference to [Eisenbud 1995, Theorem 11], as I'm no longer sure what
was intended.
