...
\fix{\cite{Piene-Schlessinger} gives a proof that there are just two components, and their intersection in nonsingular. Add this!}
...
\begin{exercise}(Iarrobino)
Show that ideals generated by *** of the forms of degree *** together with all the forms of degree $***+1$ in 4 variables
form a family in $hilb_*$ of dimension $***>***$, the dimension of the smoothing component, proving that there is at least
one more component of this
\end{exercise}
