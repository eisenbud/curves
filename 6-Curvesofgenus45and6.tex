...
Throughout our analyses of curves of genus $g = 3, 4$ and 5, we have been able to analyze the geometry of the canonical model to verify the statement of the Brill-Noether theorem in each case. In genus 6, by contrast, that is no longer the case.
...
To begin with, Brill-Noether tells us that a general canonical curve $C \subset \PP^5$ is not trigonal, but certainly trigonal curves of genus 6 exist; so the study of these curves immediately bifurcates into the trigonal and non-trigonal cases. We'll consider each of these cases in turn.
