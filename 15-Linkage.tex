...
The structure present within a given (even) linkage class was illuminated in the work of Lazarsfeld and Rao\cite{Lazarsfeld-Rao}, which proved a version of a conjecture of Harris; we close this chapter by sketching a result of their paper. But first, an elementary result:
