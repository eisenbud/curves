...
Linkage was first studied extensively in~\cite{Halphen} and taken up in the 1940's in~\cite{MR13558} and \cite{MR0052828}. The subject was modernized and generalized in~\cite{MR0364271}. Hartshorne%~\cite{****} 
and his student
...
For more results in this direction, see~\cite{MigliorePaper****} from which the argument below is taken.
