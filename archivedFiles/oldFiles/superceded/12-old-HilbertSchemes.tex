...
\fix{use $\cH_{g,r,d}$ here --- and in ch 6}
...
The open subset $\cH^\circ$ of $\cH_{3m+1}$ parametrizing twisted cubics is irreducible of dimension 12.
\end{proposition}
