...
\subsection{Finding complete linear systems on smooth plane curves}\label{linear series on smooth plane curves}
...
\section{Differentials on nodal plane curves}\label{canonical series on nodal plane curves}
...
\subsection{Linear series on a nodal curve}\label{linear series on nodal plane curves}
