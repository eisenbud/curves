...
Let's start by defining the objects we'll be considering. 

\begin{definition} Fix a degree $d$, and let $\PP^N$ be the projective space parametrizing plane curves of degree $d$.
\begin{enumerate}
