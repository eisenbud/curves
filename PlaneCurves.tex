...
\fix{make 2 the Severi variety; delete the other two
\begin{enumerate}
\item The \emph{Severi variety} $V_{d,g}$ is the locus of reduced and irreducible curves of degree $d$ and geometric genus $g$. This is a locally closed subvariety of $\PP^N$. 

\item The \emph{small Severi variety} $\widetilde V_{d,g} \subset V_{d,g}$ is the locus of plane curves of degree $d$ with $\delta = \binom{d-1}{2} - g$ nodes and no other singularities. This is a locally closed subset of $\PP^N$, as we shall see.
