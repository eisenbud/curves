...
\index{inflection point!finiteness of}%
...
\index{Calabri @Calabri, Alberto}%
\index{Kulikov, Viktor S.}%
\index{Shustin @Shustin, Eugenii}%
\index{Kharlamov @Kharlamov, Viatcheslav}%
\index{Sottile @Sottile, Frank}%
...
hyperelliptic
\index{genus 3 curve}%
\index{hyperelliptic curve!Weierstrass points}%
...
see
\index{Vermeulen @Vermeulen, Alexius Maria}%
\cite{Vermeulen}.)
...
\index{Pflueger @Pflueger, Nathan}%
...
\index{Weierstrass point!number of --s}%
