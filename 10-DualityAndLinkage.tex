...
\begin{example}[Three lines]\label{3 lines} The same argument as in Example\ref{2 lines}
\end{example}
...
\fix{We should have an example where there is not a reduced minimal element.}
