...
\label{default}
\end{figure}
\fix{Silvio: better to have 6 arrows above corresponding to the 6 below. Maybe different colors on the  
...
\label{default}
\end{figure}
\fix{Silvio: three of these points could easily be collinear; I suggest moving the "floating" point off to the left (makes the figure less high, too.)}
