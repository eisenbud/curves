...
\begin{exercise}
Let $p$ be a prime. Show that if $\pi : C \to \PP^1$ is a simply branched cover of degree $p$, then the monodromy of the map $\pi$ is the full symmetric group. 
%Show that this is false without the hypothesis that $p$ is prime.

Hint: Show that a transitive subgroup of $S_p$ generated by transpositions is all of $S_p$. 
\end{exercise}
