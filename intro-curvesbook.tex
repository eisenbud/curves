...
\begin{theorem}[Krull's Principal Ideal Theorem] \label{Krull}
...
\begin{theorem}[Generalized Principal Ideal Theorem]\label{Serre}
...
\begin{theorem}[Jordan-H\"older Theorem]\label{J-H}
...
\begin{theorem}[Chinese Remainder Theorem]\label{chinese}
