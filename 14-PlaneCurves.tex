...
If $R$ is a domain and $R'$ is a integral extension of $R$, then
 $\ff_{R'/R} \cong \Hom_{R}(\nu_{*}\sO_{C}, \sO_{C_{0}}$. To see this, note that $R and $R'$ become
 equal after tensoring with the quotient field $Q$ of $R$, and thus $Hom_{R}(R',R) \subset $Hom_{Q}(
 Q,Q) = Q$ may be identified
 with the set of elments $\alph\in Q\mid \alpha R' \subset R}. If $\alpha$ is in this set, then
  $\alpha\cdot 1 = \alpha \in R$, as required.
...
the ideal $\ff_{C/C_{0}}$, and are thus elements in the linear series $mH-\Delta$. 

It remains to prove the completeness. There is a natural  map
$\ff_{C/C_{0}} \to \sHom_{\sO_{C_{0}}}(\nu_{*}\sO_{C}, \sO_{C_{0}}$, and the argument
above shows that this map is an isomorphism on each affine open set, proving that
