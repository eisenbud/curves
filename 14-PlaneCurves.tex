...
$$
Moreover, we will show in Theorem~\ref{general adjoint} that 
$$
\ff_{C/C_{0}} = 
...
\fix{rescue some of the following}
...
\varphi_0 = \nu^* \frac{dx}{f_{y}},
$$
and $f$ is the defining equation of $C_0$ in $\AA^2$. 

Any such function is represented (modulo $(f)$) by 
