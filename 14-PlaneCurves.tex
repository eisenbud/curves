...
Finally, in Section~\ref{arbitrary plane curves} we'll describe how to answer these questions algorithmically for an arbitrary smooth curve.
...
\item We'll assume that the line at infinity $Z = 0$ intersects $C$ transversely in $d$ distinct points $p_1, dots, p_d$; by way of notation, we'll denote by $H$ the divisor $H = p_1+ \dots +p_d$ of intersection of $C$ with the line at infinity.
\end{enumerate}
