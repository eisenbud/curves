...
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig14.1.pdf"}}
\caption{A curve of geometric genus 2 represented as a plane curve of degree 4 with a node, and a canonical divisor, represented as a conic containing the node.}
\label{Fig14.1}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig14.2.pdf"}}
...
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig14.4.pdf"}}
