...
\fix{Silivo, Joe: Figure doesn't match caption. A Should not be on C; Joe and I should redraw.}
\label{Fig14.3}
\end{figure}
...
\caption{A curve $C$ of geometric genus 2 represented as a plane curve $C_{0}$ of degree 4 with a node, and a canonical divisor, represented as a conic containing the node.\fix{Silvio: Nice picture. Would be clearer if the plane of $C_{0}$ were shown. Maybe $C,C_{0}$ different colors?}
\end{figure}
...
a point of $\Delta$ on $C$. \fix{Silvio: C should be labeled. G and $D_{+}$ could be the same color}
\label{Fig14.2}
\end{figure}
