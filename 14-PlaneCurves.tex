...
$\binom{d}{2} -g$. Jeremy will help decide.} When Clebsch, Brill and Noether tried to 
...
\fix{Make exercise: State the $2m+1$ theorem, referring to the paper with Green for the proof. Make an exercise to deduce that
a nodal curve of degree $\geq \delta +3$ has gonality $d-2$ and all the $g^1_{d-2}$ are the projections from the nodes.
Hint: a $g^1_{d-2}$ is a set of points that, together with the nodes, impose dependendent conditions on forms of degree $d-3$.}
