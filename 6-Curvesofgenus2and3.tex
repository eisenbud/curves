...
\marginparhere{\vskip-100pt this isn't great but it's the best I can do. I've spent much time on it, including trying to build a paper model to help with the perspective (it didn't really help).  If you don't like this, we could either imitate closely the George Francis picture that was here in an earlier version, or you could hand-draw as accurate a sketch as possible.}}
...
\marginpar{SL: make sure this xref is unambiguous}
