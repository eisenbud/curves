...
\caption{A stationary secant.\fix{Silvio: the horizontal line plays a different role from the other lines; should be red---it's the stationary secant.}
\label{Fig9.1}
\end{figure}
...
other 5 points becomes the 4-secant line to the image of $C$. \fix{Silvio: make the two conics different colors}
\label{Fig9.2}
\end{figure}
