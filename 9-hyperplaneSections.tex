...
called a \emph{stationary secant}.


 \pict{a stationary secant}

%\pict{ rational quintic with a unique quadrisecant}
...
\pict{picture illustrating the proof; perhaps for $r = 2, m=3$: draw 6 points and 3 lines each containing 2, the 7th not on any line!}
\begin{proof}
...
\pict{g = 3: 1 triple point or 3 double points on curve of degree 5}
