...
\index{Euclid!parallel postulate}%
...
\index{Desargues!theorem on two triangles in perspective}%
...
\index{Annales@\emph{Annales de Math\'ematiques Pures at Appliqu\'ees}}%
...
\emph{Journal
\index{Journal@\emph{Journal f\"ur die reine und angewandte Mathematik}}%
...
\index{imaginary number!naming of --s}%
...
\index{Journal@\emph{Journal f\"ur reine und angewandte Mathematik}}%
...
\index{Cremona transformation!quadratic}%
