...
\begin{figure}
\includegraphics[width=200pt]{poleandpolar} 
...
length $y$, and $BB'$ and $CC'$ are parallel then $AC'$ is of length $xy$.
 \marginparhere{\redden{modified caption to make the labels less arbitrary}}
}
...
\begin{figure}
\fboxsep0pt
\fbox{\includegraphics[width=15em]{28bitangents}}
