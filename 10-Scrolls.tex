...
Let $X$ be
an irreducible, reduced variety, and suppose that $\sL,\sM$ are invertibly sheaves on $X$.
...
\end{enumerate}
In case (3) the linear series $|D|$ is basepoint free, and thus in each case the class contains reduced curves. When, in addition, $a_2>a_1$ or $q>-pa_1$ the class $|D|$ contains irreducible smooth curves.
\end{theorem}
...
\begin{corollary}
In situation 1 of Corollary~\ref{hyperelliptic and trigonal} the the class of $C\subset \PP^n$ on $S(a_1,a_2)$ is
