...
$$
\begin{aligned}
 (*_{j}) \quad \Sym^{0}G\otimes\wedge^{j}G^{*}\cdots \to \Sym^{i}G \otimes  \wedge^{i+j}G^{*}  \to \cdots
\end{aligned}
$$
...
out the 2-dimensional scroll rational normal scroll defined by the $2\times g-2$ 1-generic matrix $M$ corresponding to the decomposition of $\sO_C(1)$
