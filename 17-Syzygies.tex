...
The Eagon-Northcott complex $EN(\phi)$~\cite{****} associated with a matrix, or a map of free modules $\phi: F\to G$,
...
Let $t\in V\otimes V^{*}\subset S\otimes \wedge V^{*}$ be the ``trace element'' represented in terms of any basis $\{e_{i}\}$ of $V$
and dual basis $\{\hat e_{i}\}$ of $V^{*}$ as $t = \sum e_{i}\otimes \hat e_{i}$. Because $\wedge V^{*}$ is 
