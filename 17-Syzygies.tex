...
it is tautological: its existence depends only on the properties of commutative rings; and like the Koszul complex it is exact or not depending on the properties of the matrix $\phi$. It is part of a family of complexes described in
...
$I_{g}(\phi) = S$, and prove that $EN(\phi)^{*}$ is split exact. As before we may split $F$ and
assume that $F = G\oplus F'$, the map $\phi$ being the projection onto the first summand.
Corresponding to this splitting we have
$$
\Sym^{i-2}G \otimes  \wedge^{g+i-2}F^{*}  = 
\bigoplus \Sym^{i-2}G \otimes  \wedge^{j}G^{*} \otimes \wedge^{g+i-2-j}F'^{*}
$$
\end{proof}
