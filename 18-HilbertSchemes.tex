...
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig18.1.pdf"}}
\caption{$\sH_{0,3,3}$ has two components, whose generic members are shown above,
with the generic member of the intersection shown below. On the left is the ``principal component'' whose generic point is a smooth twisted cubic. This degenerates to a singular plane
