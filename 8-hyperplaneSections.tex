...
The first half of the chapter proves and applies a result originally due to Castelnuovo, that every subset of $n$ points in a
...
%\fix{As far as I can tell, the following discussion (of Riemann-Roch for general coherent sheaves on a curve) is completely irrelevant to what we're doing in this chapter, so I commented it out. If we do want to include it, we should think about where it should go.}
%
%in a form that is somewhat more general
