...
The first thing to do in this case is to observe that \emph{the intersection must contain an irreducible, nondegenerate surface}. This  follows from Fulton's elementary B\'ezout  theorem:
...
$V_i\cap Z_k$ is a union of components whose degrees sum to $d_i\deg V_i$. Thus
