...
\fix{We have a little problem here: we can't give the correct statement of BN until after we introduce the schemes $W^r_d$, and we can't even use the term "general curve" until we have $M_g$. How should we deal with this?}
