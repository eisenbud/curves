...
For the---perhaps more interesting---question of when  there exists a birational $g^r_d$ on \emph{some} curve of genus $g$, Castelnuovo's theorem gives a quadratic bound, roughly $d \geq \sqrt{g(2r-2)}$.
