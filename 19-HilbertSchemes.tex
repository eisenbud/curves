...
\subsection{The other component of \texorpdfstring{$\cH_{0,3,3}$}{$H_{0,3,3}_$}}
...
\marginpar{I took missing tag `balanced CI' to be identical to `balanced CI in higher codim'}
...
Indeed, the recent paper~\cite{MR3980289} shows that no moduli-rigid curves
