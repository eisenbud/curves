...
the hyperplane section of the Grassmannian in its Pl\"ucker embedding. More generally, the
...
this is equivalent to saying that the number of $\alpha_i \geq r+1-a_i$ is at least $a_i$.
 
 \fix{ finish the proof!}
\end{proof}
