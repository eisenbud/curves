...
sequence $(0,1,1)$). \fix{Joe, can you refine this? Should we call it ``Zariski's problem''?} One thing we do know is the behavior of the inflection points for a general linear series; we'll state this here and prove it as a corollary to the proof of the Brill-Noether theorem later in this chapter.
