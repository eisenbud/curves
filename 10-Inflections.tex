...
$N(S)$ is finitely generated for any surface---in characteristic 0 it is a subgroup of the quotient of the second integral homology group by the torsion elements. Its rank is called the Picard number of the surface. The result about $N(S)$ that we need is:
