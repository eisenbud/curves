...
There is a very rich classical theory of del Pezzo surfaces. The basics are treated in \cite{Beauville} and \cite{Griffiths-Harris}; for more, see the
...
and the surface is the image of $\PP^2$ under the map given by  the linear series  of cubic forms containing these points. (If $n=8$, the surface
