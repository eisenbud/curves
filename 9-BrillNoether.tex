...
%, we'll be able to put this in context; specifically, we'll see that any trigonal canonical curve lies on a unique rational normal scroll, but the type of the scroll depends on the behavior of multiples of the $g^1_3$.
...
\fix{Throughout the discussion above, we repeatedly use the fact that the $g^1_3$ on a trigonal curve of genus $g \geq 5$ is unique. Do we actually say this anywhere?}
