...
and is in particular unmixed; that is, $C$ has no 0-dimensional primary components (see for example \cite[***]{Eisenbud1995} for general
...
\pict{lines defining the group operation. Later when we do this for a plane cubic with 2 nodes, show the picture with 
conics through the nodes}
