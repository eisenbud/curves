...
{\sl 2} $\Leftrightarrow$ {\sl 4}: If  $h$ does not vanish on any component of $C$ then $h$ is a nonzerodivisor on $S_C$. The ideal $I_{C\cap H}$ is in any case the saturation of $I_C+(h)$. 
...
system of parameters is a regular sequence \cite[]{Eisenbud1995}, so $I_C+(h)$ is unmixed, and in particular, saturated.
\end{proof}
