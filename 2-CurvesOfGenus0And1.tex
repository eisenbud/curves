...
The first thing to say is that, since any linear series $\cD$ of degree $d$ on $\PP^1$ is a subseries of the complete series $|\cO_{\PP^1}(d)|$, we see that any map $\phi : \PP^1 \to \PP^r$ of degree $d$ is given as
$$
...
We first ask what surfaces contain $C$---that is, what polynomials on $\PP^3$ vanish on $C$. 
