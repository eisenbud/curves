...
algebraic varieties generally come in families parameterized by other
...
\index{bitangent}%
\index{bitangent!s on smooth quartic curves}%
\index{Salmon, George}%
Figure~\ref{fig28bitangents}. 
\blue{Salmon}
\citeyear[p.~198]{Salmon1852} 
...
at the level of 
\redden{Chapter IV and early Chapter V of}
