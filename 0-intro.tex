...
In Chapter~\ref{ScrollsChapter} we systematically describe a construction that has already appeared in different guises several times in the book: rational normal scrolls and the curves that lie on them. The last chapter presents some aspects of the theory of syzygies of the homogeneous ideals of curves and the the famous---and as of this writing open---conjecture of Mark Green that connects these to the theory of rational normal scrolls.
...
A far more extensive treatment than that of the present book can be found in the beautiful and encyclopaedic~cite{ACGH} and~\cite{ACG}; and yet even these works do not cover all the major topics in the field. Neither we nor those texts construct the Moduli space of curves,
which is in the background in this book whenever we speak of ``general'' curves of given genus. Many more ideas and details about it can be found in~\cite{HarrisMorrison1998}, though even that is not a complete account either.
