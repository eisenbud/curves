...
\index{Gilbert, William Schwenck}%
...
\index{projective space!Grothendieck convention}%
\index{Grassmannian}%
\index{P@$\PP(V)$, $\PP^r$|defi}%
\index{Sym@$\Sym$, $\Sym^i$|defi}%
