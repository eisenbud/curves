...
In the following two chapters, Chapters~\ref{linear general position chapter} and~\ref{uniform position}, we take up what may seem at first glance an unlikely topic: the hyperplane sections of a curve in projective space. This analysis has surprisingly strong consequences: for example, in  Chapter~\ref{linear general position chapter} we give Rathmann's proof that
...
and deduce a number of consequences, not least the theory of Castelnuovo curves; this in turn has as consequence the 
fact that canonical curves and linearly normal curves of high degree compared to their genera are arithmetically Cohen-Macaulay.
