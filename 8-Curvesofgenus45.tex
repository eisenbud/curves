...
We have $\h^0(\cO_{\PP^3}(2)) = \binom{5}{3} = 10$, while by the Riemann-Roch
theorem we have
$$
h^0(\cO_C(2)) = 12 - 4 + 1 = 9.
$$
...
\end{proposition}
 ...
 See Figures~\ref{Fig8.3} and \ref{Fig8.4} for an idea how this might look in the case of a smooth quadric.
  
 
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig8.3.pdf"}}
...
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig8.4.pdf"}}
...
\caption{If a genus 4 canonical curve $C$ lies on a smooth quadric, then the image of the projection of the $C$ from a point $p\in C$
...
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig8.2.pdf"}}
\caption{If a genus 4 canonical curve $C$ lies on a singular quadric, then the image of the projection of the $C$ from a point $p\in C$
...
We can now answer the first of our two questions for curves of this type. As in the genus 4 case the geometric Riemann-Roch theorem implies that $C$ has a $g^1_3$ if and only if the canonical model of $C$ contains 3 colinear points or, more generally, meets a line $L$ in a divisor of 3 not necessarily distinct points. When $C$ is the intersection of quadrics, this cannot happen, since the line $L$ would have to be contained in all the quadrics that contain $C$. Thus, in this case, 
$C$ has no $g^1_3$.

\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig8.1.pdf"}}
