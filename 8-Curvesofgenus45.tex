...
\end{proposition}
 ...
 \pict{pictures of cubic intersecting a smooth quadric and a quadric cone. The tow $g^1_3$ in the first case, the one in the second,
 can be indicated} 
...
\end{enumerate}
\pict{illustration of the tacnode case}
...
We will return to this surface in Chapter~\ref{scrollsChapter}, once we develop the theory of rational normal scrolls; see Exercise~\ref{trigonal genus 5}.
Here is the result:
