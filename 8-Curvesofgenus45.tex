...
\caption{If a genus 4 canonical curve $C$ lies on a smooth quadric, the image of the projection of the $C$ from a point $p\in C$
...
as in Figure~\ref{8.2b}. In either case, the one $g^1_3$ on $C$ is the projection from the unique singular point of $\pi(C)$.
...
is a plane quintic with a ramphoid cusp.}
\end{figure}
