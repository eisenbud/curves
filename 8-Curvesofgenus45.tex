...
\end{proposition}
 ...
 See Figure~\ref{8.3} for an idea how this might look in the case of a smooth quadric.
  
 
\begin{figure}
\begin{center}
\centerline {\includegraphics[height=2in]{"Fig8.3.pdf"}}
\caption{Canonical curve of genus 4 on a smooth quadric, showing two $g^{1_{3}}$s.}
\label{Fig8.3}
\end{center}
\end{figure}
...
\caption{Canonical curve of genus 4 on a quadric cone, with just one $g^{1_{3}}$.}
\label{Fig8.4}
\end{center}
\end{figure}

 
>>>>>>> d0d2fc4a86a019cd3da5f54319626ae51d590ed8
