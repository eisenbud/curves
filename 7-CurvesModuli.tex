...
\emph{linearly reductive} groups---see~\cite{****}.




then the ring of $G$  \fix{We should have a standard notation for homogeneous coordinate ring!!}
...
\begin{fact}
 ...
 except those birational to $C\times \PP^1$. \fix{why doesn't the theorem have hypothesis $g\geq 22$?}
