...
\end{center}
\end{figure}
\fix{Silvio: still to do, I guess}
...
C_t = V(y^2 -x^3 - t^2x - t^3)$.
\fix{Silvio: still to do, I guess. 7.A is supposed to show the degeneration $y^2 = x(x-t)(tx-1)$
}
}
\label{default}
\end{center}
...
\end{figure}
\fix{Silvio, Joe, the caption doesn't match the figure. What's the right one?}
