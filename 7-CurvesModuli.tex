...
<<<<<<< HEAD
\begin{proof} \fix{I suggest adding a proof of the second statement if we can}
We will just prove the first of these assertions. Let
=======
\begin{proof} For the first of these assertions, let
>>>>>>> 8498f4c5c20ce19805c853fb42cfe6393c3cc381
$$
...
\pict{7.1}. A process called semistable reduction, briefly described in a more general context below, shows that after a base change and a birational
