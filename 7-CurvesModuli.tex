...
is $\Proj(A^G)$, usually denoted $X//G$. In view of the example above, we must ask: what is
...
These are stable points in the Hilbert scheme of tri-canonical embeddings in the sense of geometric invariant theory.
