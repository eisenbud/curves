...
loci?), and about the geometry of the linear seriess themselves (do
...
)$ a vector space of sections, we can associate to them a linear series
...
For another example, consider the linear series cut on $C$ by cubics
...
\index{complete intersection}%
 canonical curve
\index{canonical curve!of genus 6}%
...
a different $g^{2}_{6}$.}
\index{sextic curve!with 4 nodes}%
...
\index{del Pezzo surface!of degree 3}%
\index{cubic surface!in $\PP^3$}%
