...
a different $g^{2}_{6}$. {Silvio: nice picture. Might be better to use color for the three lines of the distinguished triangle. Is the sextic mathematically correct? If not, it might be clearer if the lines of the triangle weren't so tight to the sextic\emdash they are a little hard to distinguish.}}
\label{default}
\end{figure}
