...
\begin{proof}
\noindent 1. Normalizing, we get a map  $ \tilde C \to \tilde D$, and the first statement follows from Hurwitz's theorem.
...
Over a non-algebraically closed field, a curve $C$ of genus 0 need not have any points, or any invertible sheaves of odd degree. Since the canonical bundle $K_C$ has degree $-2$, there do necessarily exist invertible sheaves of every even degree; thus an arbitrary curve of genus 0 is isomorphic to a  plane conic. 
