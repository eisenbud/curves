...
of maximal Clifford index in the odd genus case; it is 
is a theorem involving work of Hirschowitz, Ramanan and Voisin \cite{***}.
...
divisor $\Delta$ in $M_{g}$, and the Betti tables of the homogeneous coordinate rings of
curves outside this divisor all have the form
\index{Betti table}%
$$
\small
\medmuskip1mu
...
$C$ in the Hilbert scheme of smooth canonical curves of this genus, The correspond family of homogeneous coordinate
