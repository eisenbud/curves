...
\end{figure}
\fix{Silvio: This picture (spuriously) suggests a trivial deformation. There was an earlier picture of this, for plane curves, showing the perturbed curve crossing the original one; here we are (I guess) in 3-space, but we should still see the perturbed curve wrapping around the original, though not intersecting it.}
