...
A special case of this result is a bound on the size of the group of automorphisms of a curve of genus $g\geq 2$. We will give a direct proof of that result (one that doesn't rely on the Hilbert scheme) as Theorem~\ref{finite autos}.
