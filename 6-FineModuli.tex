...
In this chapter, we'll give a general framework for the notion of moduli space, introducing the main examples that we will treat in this book.
 ...
 \pict{smooth cubic morphing to a nodal , then to a reducible cubic (picture from our schemes book, I think?)}
...
\pict{a 1-parameter family of lines (lines in a plane containing a point) meets a general line exactly once}
...
\pict{3 smooth sheets meeting transversely}
