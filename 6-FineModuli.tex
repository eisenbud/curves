...
Within $\PP^N$ the set of reduced irreducible curves $\Vdgbar$ is open---it is the complement of the union of the images of the maps 
$$
...
We will see that in a neighborhood of  $ {V}_{d,g}$,  the variety $\overline V_{d,g}$  is well behaved; but away from this,
...
\begin{fact}
In 1921 F. Severi gave an incorrect proof that $\Vdg$ was connected, and this was finally proven in~\cite{MR837522}.
Many open problems remain, such as \fix{****}.
\end{fact}

\fix{I thought the result was irreducibility...}
