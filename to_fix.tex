...
\item{0-intro} Clean
To add: comparison with material of ACGH -- justification for a book covering a smll part.

\item{1-LinearSeries}
\fix{make sure we don't assume that $C$ is a smooth curves without saying so!}
Joe is proofing. all bib items are in place.
