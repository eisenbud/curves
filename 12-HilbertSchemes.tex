...
Now we can apply the Riemann-Roch formula for vector bundles on curves (\cite[Theorem ???]{3264}) to conclude that
\begin{align*}
...
\fix{ David revised to here Dec 20}
\section{Degree 8}
