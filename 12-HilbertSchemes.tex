...
\fix{Add a section on basics of the Hilbert scheme explaining why Hilbert schemes; the universal property; and the tangent space}
...
\subsection{Genus 1}
\fix{new material -- up through the exercises. DE to edit.}
...
\subsection{Genus 4}
\fix{this repeats the exercise earlier. Change or move the exercise?}
...
\begin{exercise}
Now let $C$ again be a curve of degree 6 and genus 3, but now assume that $C$ \emph{does} lie on a quadric surface $Q$. Show that such a curve is a flat limit of curves of the type described in the last exercise, and conclude that $\cH^\circ_{6m-2}(\PP^3)$ is irreducible of dimension 24. \fix{needs a hint} \end{exercise}
