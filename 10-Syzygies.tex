...
$$
 ...
 $$
 which has the value  $dt + 1+(2-d)(2-d-1)/2 = dt + (d-1)(d-2)/2 +1$. Since the degree is the leading coefficient and the genus is the constant term minus 1, we get
$\deg C = d, \hbox{genus} C = (d-1)(d-2)/2$ as we should by now expect.
\end{example}
