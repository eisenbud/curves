...
$$
 Because $X$ is locally a complete intersection and the $\sExt$ in the formula may be computed from the Koszul complex on a minimal generating set for the ideal $I$ of $X$ in $Y$. At a point $p\in X$ this complex has the form
$$
...
This computation suggests the bold idea  that the dualizing module of any closed subscheme
