...
\end{itemize}
 ...
 \subsection{projective dimension, uniqueness of minimal res, betti table, examples}  
 \fix{pd and AB formula}
 \fix{uniqueness goes here, first local then graded with betti table, and examples }
