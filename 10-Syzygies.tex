...
\subsection{Eagon-Northcott complexes as subcomplexes of the resolution}

One of the main ways in which syzygies can be seen to reflect the geometry of an embedded curve $C\subset \PP^r$
...
, and that $C$ is non-degenerate, so that 
all the forms in the ideal $I(C)$ have degree at least 2. 
