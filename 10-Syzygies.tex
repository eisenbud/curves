...
If $X,Y\subset \PP^3$ are closed, purely 1-dimensional subschemes that are directly linked then
$$
M(X)^\vee \cong M(Y)(t)
$$
...
TODO:
prove: linked curves have dual Rao modules; state converse.
state minimal linkage, all curves derived.
