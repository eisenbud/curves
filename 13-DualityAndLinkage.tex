...
Much sharper bounds are known; see for example \cite{Perrin-Martin-Deschamps 1990}.\fix{after Migliore 1.28}
...
then $X$ is minimal in its linkage class.\fix{does Larsen's thm need complete? general lb?}
\end{theorem}
